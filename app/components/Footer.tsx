    ...
    <footer id="contact" className="bg-stone-900 text-stone-300 py-24 px-12 rounded-t-[60px] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-20">
          <div>
            <h2 className="text-6xl font-serif text-white leading-tight mb-10">
              Ready to create <br />your perfect home?
            </h2>
            <p className="text-xl text-stone-400 mb-12 max-w-md">
              Let's discuss your vision and turn your blueprints into a reality that transcends expectations.
            </p>
            <div className="flex flex-col gap-6">
              <a href="mailto:4ward@gmail.com" className="text-3xl font-serif text-white hover:opacity-60 transition-opacity">4ward@gmail.com</a>
              <a href="tel:+1234567890" className="text-3xl font-serif text-white hover:opacity-60 transition-opacity">+1 (234) 567-890</a>
            </div>
          </div>
